...
namespace hyperon {
    namespace alg {
        ...
        void BuildCTWindow(
                ...
                const int window_wires,
                const int window_ticks, // XXX: ignored for now
                float min_adc_value) {
            ...
            const int start_wire_u = nu_wire_u - ((int)window_wires / 2);
            const int start_wire_v = nu_wire_v - ((int)window_wires / 2);
            const int start_wire_y = nu_wire_y - ((int)window_wires / 2);
