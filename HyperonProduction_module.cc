...
struct hyperon::Config {
    ...
    Atom<bool>        fRunConnectedness       { Name("RunConnectednes"),
                                                Comment("Flag to turn on the Connectedness island-finding algorithm") };
    Atom<double>      fConnectednessThreshold { Name("ConnectednessThreshold"),
                                                Comment("ADC value threshold to be used by the Connectedness test") };
